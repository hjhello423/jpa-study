...
import com.hongjun423.jpastudy.domain.Address;
import com.hongjun423.jpastudy.domain.Member;
import com.hongjun423.jpastudy.domain.Order;
import com.hongjun423.jpastudy.domain.OrderStatus;
...
public class OrderServiceTest {
    ...
    private Book createBook(String nam, int price, int stockQuantity) {
        Book book = new Book();
        book.setName(nam);
        book.setPrice(price);
